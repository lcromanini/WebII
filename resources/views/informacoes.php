...
#header { background:url(images/header_bckg_main.jpg) repeat-x  #5DDAD8  0; }
...
#footer { background:url(images/footer_bckg.jpg) #5DDAD8  ; height:102px; clear:both; font-style:italic }
...
<div id="container">
  <div id="header">
    <div id="logo"><a href="#">O Desenvolvedor</a> <br/>
      Dando os primeiros passos em Desenvolvimento de Software </div>
    <div id="menu">
      <ul>
          <li><a href="welcome">Principal</a></li>
  ...
  <div id="main">
    ...
    <div id="text" >
      ...
      <p>Meu nome é <strong>Luis</strong> e eu temho 28 anos. Sou estudante do curso de Análise e Desenvolvimento de Sistema. </p>
      


<p>O meu objetivo ao fazer o curso de Análise e Desenvolvimento de Sistema é me tornar um profissonal da área de Desenvolvimento. para mim está é uma área em grande expansão. A tecnologia está avançandocada vez mais. Isso traz novas oportunidades de trabalho, novos desafios e também novas esperiências. Estou me esforçando para adquirir os conhecimentos necessários para me tornar um bom profissional. Um profissional qualificado e dedicado. Hoje eu não trabalho na área de desenvolvimento, mas após concluir o curso desejo ingressar na área, fazer especializações e buscar o meu espaço neste mar de oportunidades. </p>
      


<h4>"Quem acredita sempre alcança"</h4>
